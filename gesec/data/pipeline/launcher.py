...
def launch_pipeline(ministere: str | None = None, n_workers: int | None = None):
    ...
    bronze.cpro_export_facture_xml.process_files_to_bronze(unzipped_folder, ministere=ministere, n_workers=n_workers)
    bronze.cpro_export_factur_x.process_files_to_bronze(unzipped_folder, ministere=ministere, n_workers=n_workers)
    bronze.cpro_export_factures.process_csvs_to_bronze(exports_folder, n_workers=n_workers)
